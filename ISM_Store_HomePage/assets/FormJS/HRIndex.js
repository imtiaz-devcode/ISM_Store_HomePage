...
function SaveAnnouncement() {
    ...
    postRequest(BaseURL + "ISM_Store_HomePage_WebService.asmx/SaveAnnouncement", obj, function (res) {
        if (res.d.Message != "") {
            if (!res.d.Status) {
...
function SaveUpComingEvent() {
    ...
    postRequest(BaseURL + "ISM_Store_HomePage_WebService.asmx/SaveUpcomingEvent", obj, function (res) {
        if (res.d.Message != "") {
            if (!res.d.Status) {
                ShowErrorAlert("Oops...", res.d.Message + " !", 'error');
            }
